...
DEMO_USERS = [
    ...
    {"id": 4, "email": "ai@somnia.network", "password_hash": "", "name": "AI Doctor", "role": "DOCTOR", "credits": 0, "t800_balance": 0, "is_active": True, "email_verified": True, "phone_verified": False, "verification_level": "verified", "somnia_address": "0x0000000000000000000000000000000000000000", "is_deleted": False, "phone": None, "hashgraph_account_id": None, "somnia_private_key": None, "inconvenience_discount_amount": 0, "inconvenience_discount_active": False, "inconvenience_discount_reason": None, "created_at": "2026-05-18T19:46:22"},
...
DEMO_DOCTORS = [
    ...
    {"id": 2, "user_id": 4, "name": "AI Doctor", "specialty": "General Practice (AI)", "area": "Global", "bio": "Autonomous AI medical assistant powered by Somnia LLM.", "rating": 5.0, "review_count": 0, "consultation_fee": 50, "is_available": True, "verification_status": "verified", "profile_completed": True, "is_online": True, "gig_mode_enabled": True, "quick_chat_price": 50, "video_call_price": 50, "full_consultation_price": 50, "prescription_review_price": 50, "report_analysis_price": 50, "peak_pricing_multiplier": 1.0, "total_earnings": 0, "pending_earnings": 0, "subscription_active": False, "photo_url": None, "hpcsa_number": None, "id_number": None, "hashgraph_account_id": None, "subscription_end": None, "subscription_stt_paid": 0.0, "created_at": "2026-06-05T19:46:22"},
]
